...
Transport theory, allowing for a coupling to an evolving medium with fluctuating initial conditions, has become a powerful tool in this endeavor. 
...
\end{eqnarray}
where $C_i$ is the color factor of each parton and $\int_{\mathbf{q}} = \int d\mathbf{q}_\perp/(2\pi)^2$.
