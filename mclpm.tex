...
\begin{document}
\title{A modified-Boltzmann approach for modeling the QCD Landau-Pomeranchuk-Migdal (LPM) effect of medium-induce splitting vertices in the deep LPM region}
\author{Weiyao Ke}
\author{Yingru Xu}
